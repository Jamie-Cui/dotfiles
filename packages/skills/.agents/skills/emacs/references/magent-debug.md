...
- Read `references/magent-live-emacs-debug.md` when you need the live-debug checklist, the standard repro prompts, or the stale-state checklist.
- Read `references/magent-symptom-map.md` when you need a quick mapping from symptom to likely files, buffers, and subsystems.
