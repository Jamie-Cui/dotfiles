...
Components are =shell=, =font=, =vim=, =nvim=, =emacs=, =kitty=,
=flameshot=, =rime=, =x11=, =i3=, =rofi=, =hyprland=, =waybar=,
=dunst=, =mail=, =secrets=, =aerospace=, and =borders=.  Dependencies are
added automatically; explicitly excluding a required dependency is an error.
