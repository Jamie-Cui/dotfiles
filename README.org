...
shell, font, editor, terminal, Tailscale, and Rime tools; plus Alfred, Stats,
Caffeine, and AeroSpace on macOS), and =all=.  Individual components can be adjusted with repeatable =--with= and
...
=alfred=, =stats=, =aerospace=, and =borders=.  Dependencies are added automatically; explicitly
