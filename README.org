...
#+begin_src bash
curl -fsSL https://raw.githubusercontent.com/Jamie-Cui/dotfiles/master/scripts/setup.sh | bash
#+end_src
...
#+begin_src bash
curl -fsSL https://raw.githubusercontent.com/Jamie-Cui/dotfiles/master/scripts/setup.sh | \
...
#+begin_src bash
tmp=$(mktemp)
curl -fsSL https://raw.githubusercontent.com/Jamie-Cui/dotfiles/master/scripts/setup.sh -o "$tmp"
less "$tmp"
bash "$tmp"
#+end_src
