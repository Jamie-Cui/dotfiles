...
shell, font, editor, terminal, and Rime tools; plus Alfred, Stats, and AeroSpace
on macOS), and =all=.  Individual components can be adjusted with repeatable =--with= and
