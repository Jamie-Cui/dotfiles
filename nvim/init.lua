...
vim.keymap.set('n', '<leader>ca', vim.diagnostic.setloclist, { desc = 'Open diagnostic [Q]uickfix list' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- In insert mode: Exit to Normal mode with C-g
      vim.keymap.set('i', '<C-g>', '<Esc>', { noremap = true, desc = 'Emacs-style exit insert mode' })

      -- In command mode: Cancel command/prompt
      vim.keymap.set('c', '<C-g>', '<C-c>', { noremap = true, desc = 'Emacs-style cancel command' })

      -- Optional: If you use Terminal mode
      vim.keymap.set('t', '<C-g>', '<C-\\><C-n>', { noremap = true, desc = 'Emacs-style exit terminal mode' })


      -- See `:help telescope.builtin`
      local builtin = require 'telescope.builtin'
      vim.keymap.set('n', '<M-x>', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
      vim.keymap.set({'n', 'v' }, '<M-f>', builtin.grep_string, { desc = '[S]earch current [W]ord' })
      vim.keymap.set({'n', 'i', 'v'}, '<M-s>', '<Esc>:w<CR>a', { noremap = true, silent = true })

      vim.keymap.set('n', '<leader>.', builtin.find_files, { desc = 'Find Files' })
      vim.keymap.set('n', '<leader>fr', builtin.oldfiles, { desc = 'Find Recent Files' })
      vim.keymap.set('n', '<leader>pf', builtin.live_grep, { desc = 'Project Find' })
      ...
      vim.keymap.set('n', '<leader>br', ':e!<CR>', { silent = true, desc = 'Revert buffer' })
      ...
      vim.keymap.set('n', '<leader>ht', builtin.help_tags, { desc = '[S]earch [H]elp' })
      ...
      vim.keymap.set('n', '<leader>hf', builtin.commands, { desc = '[S]earch [C]ommands' })
      ...
      vim.keymap.set('n', '<leader>fp', function() builtin.find_files { cwd = vim.fn.stdpath 'config' } end, { desc = '[S]earch [N]eovim files' })
    end,
  },
