...
PACKAGES_macos := vim nvim emacs kitty aerospace bin vdirsyncer skills $(SECRETS_PACKAGE)
PACKAGES_linux := vim nvim emacs kitty bin x11 rofi i3 i3blocks hypr waybar dunst flameshot fcitx5 gtk-2.0 gtk-3.0 gtk-4.0 imsettings davmail isync vdirsyncer skills $(SECRETS_PACKAGE)
